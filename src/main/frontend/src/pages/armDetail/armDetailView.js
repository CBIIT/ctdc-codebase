...
const ArmDetail = ({ classes, data, theme }) => {
  const armData = data.armDetail;
  armData.numberOfCases = armData.diagnosis.reduce((a, i) => a + i.cases, 0);
  armData.widgetData = armData.diagnosis.map((e) => ({ item: e.disease, cases: e.cases }));
  ...
  const redirectTo = () => {
    dispatch(initDashboardStatus()).then(() => {
      dispatch(singleCheckBox([{
        groupName: 'Trial Arm',
        name: `${armData.arm_id}_${armData.arm_drug}`,
        datafield: 'trial_arm',
        isChecked: true,
      }]));
    });
  ...
  const stat = {
    numberOfCases: armData.numberOfCases,
    numberOfTrials: 1,
        ...
        <div className={classes.header}>
          ...
          <div className={classes.headerTitle}>
            ...
            <div className={cn(classes.headerMSubTitle, classes.headerSubTitleCate)}>
              <span>
                {' '}
                {armData.clinical_trial_short_name}
              </span>
          ...
          <Grid container spacing={5}>
            ...
            <Grid item className={classes.firstColumn} lg={false} md={false} sm={12} xs={12}>
              <Grid container spacing={4} direction="row" className={classes.detailContainerLeft}>
                <Grid item xs={12}>
                  <span className={classes.detailContainerHeader}> ARM TITLE </span>
                </Grid>
                <Grid item xs={12}>
                  <div>
                ...
                <Grid item xs={12} className={classes.paddingTop32}>
                  <span className={classes.detailContainerHeader}>ARM DRUG</span>
                </Grid>
                <Grid item xs={12}>
                  <div>
                    <span className={classes.content}>
                ...
                {/* Pubmed ID */}
                <Grid item xs={12} className={classes.paddingTop32}>
                  <span className={classes.detailContainerHeader}>Pubmed ID</span>
                </Grid>
                <Grid item xs={12}>
                  <div>
                    <span className={classes.content}>
                ...
                <Grid item xs={12} className={classes.paddingTop32}>
                  <span className={classes.detailContainerHeader}>INCLUSION CRITERIA</span>
                </Grid>
      ...
      <div id="table_trial_detail" className={classes.tableContainer}>
        ...
        <div className={classes.tableDiv}>
          <div className={classes.tableTitle}>
            <span className={classes.tableHeader}> EXCLUSION CRITERIA </span>
          </div>
          <Grid item xs={12}>
        ...
        <div className={classes.tableDiv}>
          <div className={classes.tableTitle}>
            <span className={classes.tableHeader}> DISEASES </span>
          </div>
          <Grid item xs={12}>
