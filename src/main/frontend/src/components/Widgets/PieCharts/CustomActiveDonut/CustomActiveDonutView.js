...
const renderActiveShape = (props) => {
  ...
  return (
    <g>
      <text y={9} fill={textColor} fontSize={fontSize || '12px'} fontWeight="600" fontFamily="Raleway">{String(payload.name).length > 23 ? `${String(payload.name).substr(0, 23)}...` : payload.name}</text>
